...
public final class InMemoryTerminalSession: @unchecked Sendable {
    ...
    public init(
        ...
        suppressesTerminalResponses: Bool = false
    ) {
        writeHandler = write
        resizeHandler = resize
        self.suppressesPixelOnlyResizes = suppressesPixelOnlyResizes
        surfaceAccess = InMemoryTerminalSurfaceAccess(
            write: { surface, data in
                Self.writeToSurface(surface, data, suppressesTerminalResponses: suppressesTerminalResponses)
            },
    ...
    private static func writeToSurface(
        _ surface: ghostty_surface_t, _ data: Data, suppressesTerminalResponses: Bool
    ) {
        ...
        data.withUnsafeBytes { buffer in
            ...
            if suppressesTerminalResponses {
