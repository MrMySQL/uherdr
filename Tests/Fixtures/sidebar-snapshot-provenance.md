...
The latter two share IDs and labels intentionally. Replacing the metadata fixture with the legacy one simulates snapshot token expiry/removal; independently seeded sessions exercise device isolation.
