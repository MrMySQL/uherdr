...
- Long multiline paste requires the [runtime terminal-mode patches](Vendor/HerdrRuntime/README.md), including bracketed-paste forwarding. Rebuilding the native app alone does not update the server.
...
bash scripts/test-terminal-paste.sh # End-to-end long paste (requires patched runtime)
