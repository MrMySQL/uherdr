...
- Links: click a web URL or labeled hyperlink in terminal output to open it in your default browser, including in mouse-enabled applications such as Claude Code. Command-click also works; dragging selects text and copies it on release. With stock Herdr 0.9.0 (protocol 22), application mouse events and clipboard writes are forwarded too, including application-owned selection in Claude Code fullscreen mode. Hold Shift while dragging to select and copy locally instead.
